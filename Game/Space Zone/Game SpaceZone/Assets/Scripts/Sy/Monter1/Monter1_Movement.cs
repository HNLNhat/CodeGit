...
public class Monter1_Movement : MonoBehaviour
{
    [SerializeField] private Transform point1;
    [SerializeField] private Transform point2;
    private float moveSpeedMonter1 = 3f;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            transform.position = Vector3.MoveTowards(transform.position, target, moveSpeedMonter1 * Time.deltaTime);
    ...
    private void move()
    {
        ...
        if (isLeft)
        {
            transform.Translate(Vector3.left * Time.deltaTime * moveSpeedMonter1);
            spr.flipX = true;
        }
        else
        {
            transform.Translate(Vector3.right * Time.deltaTime * moveSpeedMonter1);
            spr.flipX = false;
        }
    }
