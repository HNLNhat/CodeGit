...
public class Monter3_Movement : MonoBehaviour
{
    [SerializeField] private Transform point1;
    [SerializeField] private Transform point2;
    private float moveSpeedMonter3 = 6f;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            transform.position = Vector3.MoveTowards(transform.position, target, moveSpeedMonter3 * Time.deltaTime);
    ...
    private void move()
    {
        ...
        if (isLeft)
        {
            transform.Translate(Vector3.left * Time.deltaTime * moveSpeedMonter3);
            spr.flipX = true;
        }
        else
        {
            transform.Translate(Vector3.right * Time.deltaTime * moveSpeedMonter3);
            spr.flipX = false;
        }
    }
